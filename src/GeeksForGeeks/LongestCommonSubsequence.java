...
//	    Just extracting what we certainly will need and being explicit
	    ...
	    */
	    ...
	    else 
	    {
	      ...
	      */
	      return Math.max(longestCommonsubsequenceLength(s1, s2WithoutFinalCharacter), longestCommonsubsequenceLength(s1WithoutFinalCharacter, s2));
	    }
	  }
	}
	...
	public static void main(String[] args) 
	{
		...
		TopDown recursive = new TopDown();
		int lcs_1 = recursive.longestCommonsubsequenceLength("AGGTAB", "GXTXAYB");
		System.out.println(lcs_1);
		
		
		BottomUp dp_iterative = new BottomUp();
		int lcs_2 = dp_iterative.longestCommonsubsequenceLength("AGGTAB", "GXTXAYB");
