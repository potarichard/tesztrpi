...
// we have caps that ids can be 1,2...100
// we have people who have caps
// find unique ways so all people have different hats
...
// megoldashoz 2n  subset, bitmaskos modszer.
// Max 10 ember lehet, 
public class DP2_BitmaskingCaps 
{
...
//                capList[x].add(i); 						// melyik sapka az index (x), melyik embereknek (i), x indexen egy tomb van az ember id val akinek van olyan sapija
//            } 
//            
//        } 
        //---------------------------------------------------- 
