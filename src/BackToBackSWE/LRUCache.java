...
public class LRUCache {
	  ...
	  public LRUCache(int maxCapacity) 
	  {
	    ...
	    head = new ListNode(-11,-123);
	    tail = new ListNode(-11, 456);
	  ...
	  public ListNode getNewestModified() {
		  System.out.println("most recent: " + head.next.value);
		  return head.next;
	  }
	  
	  public ListNode getOldestModified() {
		  System.out.println("last: " + tail.prev.value);
		  return tail.prev;
	  }
	...
	public static void main(String[] args) 
	{
		...
		// rewrite a value already in
		cache.put(1, 200);
		
		cache.getNewestModified();
		cache.getOldestModified();
